...
- **2024-02-18** | [Atom of Thoughts for Markov LLM Test-Time Scaling](https://arxiv.org/abs/2502.12018) | [code]()
- **2024-02-06** | [Self-Supervised Prompt Optimization](https://arxiv.org/abs/2502.06855)  
- **2024-10-10** | 🚀 ICLR 2025 oral, LLM Agent #2 | [AFlow: Automating Agentic Workflow Generation](https://arxiv.org/abs/2410.10762) | [code](https://github.com/geekan/MetaGPT/tree/main/examples/aflow)
- **2024-10-21** | [FACT: Examining the Effectiveness of Iterative Context Rewriting for Multi-fact Retrieval](https://arxiv.org/abs/2410.21012)  | [code]() 
- **2024-10-17** | [SELA: Tree-Search Enhanced LLM Agents for Automated Machine Learning](https://arxiv.org/abs/2410.17238)  | [code](https://github.com/geekan/MetaGPT/tree/main/examples/sela)
- **2024-02-18** | [Data Interpreter: An LLM Agent For Data Science](https://arxiv.org/abs/2402.18679)  | [code](https://github.com/geekan/MetaGPT/tree/main/examples/di)
- **2023-08-01** | 🚀 ICLR 2024 oral, LLM Agent #1 | [MetaGPT: Meta Programming for A Multi-Agent Collaborative Framework](https://arxiv.org/abs/2308.00352)  | [code](https://github.com/geekan/MetaGPT)
